...
import { decrement, increment } from "src/app/globalReux/feature/cartSlice";
import { addToWishList } from "src/app/globalReux/feature/wishListSlice";
import { RootState } from "src/app/globalReux/store";
import { ICartProduct } from "src/app/interface/product";
    ...
    <div className="w-full h-28 p-3 border rounded-sm flex justify-between gap-2">
      ...
      <div className="h-full flex-1 flex flex-col content-between justify-between">
        ...
        <div className="flex justify-between items-end">
          <h1 className="text-xl text-skyblue">${item.price}</h1>
